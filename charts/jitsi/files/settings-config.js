...
{{ $ENABLE_P2P := .Env.ENABLE_P2P | default "false" | toBool -}}
...
// Giphy
config.giphy = { enabled: true, sdkKey: 'xL9gUISOB9vvb9UV3giMl4cV68mI0Gas', displayMode: 'all', tileTime: 5000 };
...
// SSI
config.deploymentInfo.userRegion ='<!--# echo var="region" -->'; // SSI Instruction
config.deploymentInfo.region ='<!--# echo var="region" -->'; // SSI Instruction
